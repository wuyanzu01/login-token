...
public class DateUtils {
     ...
     * @return
     */
    public static Long msecToSeconds(Long msec){
        return  msec/1000;
    }
     ...
     * @return
     */
    public static Date targetDateMinusNow(Date targetDate){

       Date date = new Date( targetDate.getTime() - System.currentTimeMillis());
       return date;
    }
